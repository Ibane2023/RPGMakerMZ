 ...
 * 
 * @help
 * このプラグインを導入すると、メインメニューのステータスウィンドウの代わりに
 * 新しいウィンドウが表示され、ウィンドウには
 * 画像ファイルやテキストを表示することができます。
 * 
 * プラグインパラメータ:
 * - カスタム画像ファイル: カスタムステータスウィンドウに表示する画像のファイルパスを設定します。
 * - カスタムテキスト: カスタムステータスウィンドウに表示するテキスト情報を設定します。
 * - 画像リサイズフラグ: 画像をウィンドウの幅に合わせて拡大・縮小するかどうかを制御します。
